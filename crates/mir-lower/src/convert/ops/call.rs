...
fn convert_rust_float_math_intrinsic(
    ...
    // MXMACA remaps libdevice `__nv_*` entry points to `mc_math_func_*`.
...
fn float_math_intrinsic_symbol(
    ...
    if crate::context::lowering_options(ctx).backend == crate::BackendTarget::Maca {
        let libdevice_name = intrinsic.libdevice_name(ctx, result_ty, loc.clone())?;
        return Ok(backend_math_symbol(ctx, libdevice_name).leak());
    }
    ...
    fn no_fma_policy_removes_only_contract_from_fast_float_intrinsics() {
        ...
        crate::context::set_lowering_options(
            ...
            crate::LoweringOptions {
                ...
                backend: crate::BackendTarget::Cuda,
                intrinsic_backend: crate::IntrinsicBackend::LlvmNvptx,
            },
        );
