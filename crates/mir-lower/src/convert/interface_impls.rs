...
use dialect_nvvm::ops::{
    AssertFailOp, CvtaGenericToSharedOffsetOp, InlinePtxOp, MmaM16N16K16F32Bf16Op,
    MmaM16N16K16F32F16Op, MmaM16N16K16I32I8Op, NvvmAtomicCmpxchgOp, NvvmAtomicFenceOp,
...
// ---- MXMACA (MetaX C500) native m16n16k16 MMA ops --------------------------

#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N16K16F32F16Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n16k16_f32_f16(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N16K16F32Bf16Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n16k16_f32_bf16(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
...
#[op_interface_impl]
impl MirToLlvmConversion for MmaM16N16K16I32I8Op {
    fn convert(
        &self,
        ctx: &mut Context,
        rewriter: &mut DialectConversionRewriter,
        ...
        super::intrinsics::wmma::convert_mma_m16n16k16_i32_i8(
            ctx,
            rewriter,
            self.get_operation(),
            operands_info,
