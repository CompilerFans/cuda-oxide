...
fn try_dispatch_intrinsic(
    ...
    match name {
        ...
        // =================================================================
        "cuda_device::wmma::mma_m16n16k16_f32_f16" => {
            Ok(Some(intrinsics::wmma::emit_mma_m16n16k16_f32_f16(
                ctx,
                body,
                args,
                destination,
        ...
        "cuda_device::wmma::mma_m16n16k16_f32_bf16" => {
            Ok(Some(intrinsics::wmma::emit_mma_m16n16k16_f32_bf16(
                ctx,
                body,
                args,
                destination,
        ...
        "cuda_device::wmma::mma_m16n16k16_i32_i8" => {
            Ok(Some(intrinsics::wmma::emit_mma_m16n16k16_i32_i8(
                ctx,
                body,
                args,
                destination,
