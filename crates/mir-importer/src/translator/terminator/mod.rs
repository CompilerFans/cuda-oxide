...
fn try_dispatch_intrinsic(
    ...
    // MXMACA (MetaX C500) native Wave64 MMA extension: these three
    // `mma_m16n16k16_*` intrinsics are not part of the generated catalog.
    if let Some(operation) = intrinsics::maca_mma::try_dispatch(
        ctx,
        body,
        name,
        args,
