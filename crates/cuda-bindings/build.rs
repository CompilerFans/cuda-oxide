...
/// never all of `targets/*`. For a cu-bridge (MXMACA) toolkit the driver library lives
/// directly under `{toolkit}/lib`, which is prepended. Order is preserved; duplicates
/// are not filtered.
